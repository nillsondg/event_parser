...
def read_events_from_file(folder, file_name):
    exist_urls = set()
    try:
...
def read_completed_urls(file_name):
    return read_events_from_file(events_desc_folders, file_name)


def read_checked_urls(file_name):
    return read_events_from_file(events_folder, file_name)
